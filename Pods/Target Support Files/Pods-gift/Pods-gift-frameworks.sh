...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-gift/AlamofireObjectMapper.framework"
  install_framework "Pods-gift/Async.framework"
  install_framework "Pods-gift/Bolts.framework"
  install_framework "Pods-gift/Cartography.framework"
  ...
  install_framework "Pods-gift/ImagePicker.framework"
  install_framework "Pods-gift/Kingfisher.framework"
  install_framework "Pods-gift/Locksmith.framework"
  install_framework "Pods-gift/MZTimerLabel.framework"
  install_framework "Pods-gift/NVActivityIndicatorView.framework"
  install_framework "Pods-gift/ObjectMapper.framework"
  install_framework "Pods-gift/PMAlertController.framework"
  install_framework "Pods-gift/RAMAnimatedTabBarController.framework"
  install_framework "Pods-gift/SwiftDate.framework"
